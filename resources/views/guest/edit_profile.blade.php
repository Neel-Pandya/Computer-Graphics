                        ...
                        <div class="row">
                            <div class="col-lg-6 col-sm-12 col-md-6 mt-4">
                                ...
                                <input type="text" name="customer_name" id=""
                                    value="{{ $userData->customer_name }}" class="form-control">
                            ...
                            <div class="col-lg-6 col-sm-12 col-md-6 mt-4">
                                ...
                                <input type="email" name="customer_email" id=""
                                    value="{{ $userData->customer_email }}" class="form-control" readonly>
                            </div>
                            <div class="col-lg-6 col-sm-12 col-md-6 mt-4">
                                <label for="" class="form-label">Mobile</label>
                                <input type="number" name="customer_mobile" id=""
                                    value="{{ $userData->customer_mobile }}" class="form-control">
                                <span class="text-danger">
