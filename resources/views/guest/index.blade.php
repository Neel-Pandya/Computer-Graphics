...
<body>
    ...
    <div class="index-offers-img">
        <a href="categories.html"><img src="{{ URL::to('/') }}/images/index-img/1.png" alt=""></a>
        <a href="categories.html"><img src="{{ URL::to('/') }}/images/index-img/2.png" alt=""></a>
        <a href="categories.html"><img src="{{ URL::to('/') }}/images/index-img/3.png" alt=""></a>
        <a href="categories.html"><img src="{{ URL::to('/') }}/images/index-img/4.png" alt=""></a>
    </div>

    <br><br>

    <div class="index-grid-img-1">
        <a href="categories.html"><img src="{{ URL::to('/') }}/images/index-img/anton-levin-P8prss71psk-unsplash.jpg" alt="" srcset=""></a>
        <a href="categories.html"><img src="{{ URL::to('/') }}/images/index-img/bogdan-glisik-2WgOPYJuPsU-unsplash (1).jpg" alt=""
                srcset=""></a>
        <a href="categories.html"><img src="{{ URL::to('/') }}/images/index-img/calvin-lupiya--yPg8cusGD8-unsplash.jpg" alt=""></a>
    ...
    <div class="index-grid-img-2">
        <a href="products.html"><img src="{{ URL::to('/') }}/images/index-img/ethan-haddox-QHGcADeeT00-unsplash.jpg" id="trans-img"
                alt=""></a>
        <a href="products.html"><img src="{{ URL::to('/') }}/images/index-img/andres-jasso-PqbL_mxmaUE-unsplash (1).jpg" alt=""></a>
        <a href="products.html"><img src="{{ URL::to('/') }}/images/index-img/raul-hender-afc4HxPy2GM-unsplash (1).jpg" alt=""></a>
        <a href="products.html"><img src="{{ URL::to('/') }}/images/index-img/nike.png" alt="" srcset=""></a>
        <a href="products.html"><img src="{{ URL::to('/') }}/images/index-img/my-shoes2.png" alt="" srcset=""></a>
        <a href="products.html"><img src="{{ URL::to('/') }}/images/index-img/my-shoes3.png" alt="" srcset=""></a>
    </div>
    ...
    <div class="index-grid-img-3">
        <a href="products.html"><img src="{{ URL::to('/') }}/images/index-img/girl1.png" alt=""></a>
        <a href="products.html"><img src="{{ URL::to('/') }}/images/index-img/girl2.png" alt="" srcset=""></a>
        <a href="products.html"><img src="{{ URL::to('/') }}/images/index-img/girl3.png" alt=""></a>
        <a href="products.html"><img src="{{ URL::to('/') }}/images/index-img/girl4.png" alt="" srcset=""></a>
    </div>
    <!-- ALL THE LINKS WILL GO TO products.html -->
