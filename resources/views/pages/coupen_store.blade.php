...
@endphp
<h4 class="text-primary text-center">Coupen Add</h4>
<form action="{{ route('coupen.store') }}" method="post">
    @csrf
    <div class="row">
        <div class="col-lg-6 col-md-6 col-sm-12 mt-4">
            <label for="" class="form-label">Enter Coupen Name</label>
            <input type="text" name="coupen_name" id="" class="form-control" placeholder="Enter coupen name" value="{{ old('coupen_name') }}">
