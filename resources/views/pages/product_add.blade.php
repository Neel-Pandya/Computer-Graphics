...
<form action="{{ route('products.store')}}" method="POST" enctype="multipart/form-data">
    ...
    <div class="row">
        ...
        <div class="mt-4 col-lg-6 col-md-6 col-sm-12">
            ...
            <input type="number" name="product_price" id="" class="form-control" placeholder="Enter Product Price"
        ...
        <div class="mt-4 col-lg-6 col-md-6 col-sm-12">
            ...
            <select name="product_category" id="" class="form-select form-control">
                ...
                <option value="{{ $category }}" @if (old('product_category')==$category) selected @endif>{{ $category }}
                </option>
                @endforeach
            </select>
            <span class="text-danger">
        ...
        <div class="mt-4 col-lg-6 col-md-6 col-sm-12">
            ...
            <select name="product_for" id="" class="form-select form-control">
                ...
                <option value="{{ $gender }}" @if (old('product_for')==$gender) selected @endif>{{ $gender }}</option>
                @endforeach
            </select>
            <span class="text-danger">
                @error('product_for')
        ...
        <div class="mt-4 col-lg-6 col-md-6 col-sm-12">
            ...
            <select name="product_size" class="form-control form-select" id="">
                ...
                <option value="{{ $product }}" @if (old('product_size')==$product) selected @endif>{{ $product }}
                </option>
                @endforeach
