...
<h4 class="text-primary text-center">Edit Profile</h4>
    ...
    <div class="row">
        <div class="mt-4 col-lg-6 col-md-6 col-sm-12">
            ...
            <input type="text" name="admin_name" id="" class="form-control" placeholder="Enter Admin name" value="{{ $admin->admin_name }}">
        ...
        <div class="mt-4 col-lg-6 col-md-6 col-sm-12">
            ...
            <input type="email" name="admin_email" id="" class="form-control" placeholder="Enter Admin email" value="{{ $admin->admin_email }}" readonly>
