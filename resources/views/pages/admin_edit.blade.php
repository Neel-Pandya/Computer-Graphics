...
@section('content')
    ...
    <div class="row">
        ...
        <form action="{{ route('admin.update') }}" method="POST" enctype="multipart/form-data" class="col-lg-8 col-md-6 col-sm-12">
            @csrf
                
                    <label for="" class="form-label mt-4">Admin name</label>
                    <input type="text" name="admin_name" id="" class="form-control"
                        placeholder="Enter Admin name" value="{{ $admin->admin_name }}">
                    ...
                    <input type="email" name="admin_email" id="" class="form-control"
                        placeholder="Enter Admin email" value="{{ $admin->admin_email }}" readonly>
