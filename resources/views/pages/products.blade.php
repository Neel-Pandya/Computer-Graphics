                            ...
                            <tr>
                                ...
                                <td>
                                    @if ($record->Product_status == 'Active')
                                        <a
                                            href="{{ route('products.deactivate', ['product_id' => $record->Product_id]) }}"><button
                                                class="btn btn-danger">Deactivate</button></a>
                                    @elseif($record->Product_status == 'Inactive')
                                        <a
                                            href="{{ route('products.activate', ['product_id' => $record->Product_id]) }}"><button
                                                class="btn btn-success">Activate</button></a>
                                    @elseif($record->Product_status == 'Deleted')
                                        <a
                                            href="{{ route('products.reactivate', ['product_id' => $record->Product_id]) }}"><button
                                                class="btn btn-danger">Reactivate</button></a>
                                    @endif
                                </td>
                                <td><a
                                        href="{{ route('products.edit', ['product_id' => $record->Product_id]) }}"><button
                                            class="btn btn-primary">Edit</button></a></td>

                                <td><a
                                        href="{{ route('products.delete', ['product_id' => $record->Product_id]) }}"><button
