    ...
    <li class="nav-item">
      ...
      <div class="collapse" id="ui-basic">
        <ul class="nav flex-column sub-menu">
          <li class="nav-item"> <a class="nav-link" href="{{ route('products.available') }}">Available Products</a></li>
          <li class="nav-item"><a href="{{ route('products.purchase') }}" class="nav-link">Purchased Products</a></li>
        </ul>
      </div>
    </li>
    <li class="nav-item">
